...
\begin{exo}[PC][1][TD]{Indice optique du méthane}
  ...
  \begin{center}
  \includegraphics[width=0.5\textwidth]{mach_zehnder.png}
  \end{center}
...
$$  \boxed{p_{\rm air} = \frac{\delta}{\lambda} = \frac{n_{\rm air} (L_2-L_1)}{\lambda}.}$$
  }
...
$$  \boxed{p_{\rm ch4}  = p_{\rm air}  + (n_{ch4} - n_{\rm air})\frac{\ell}{\lambda}.}$$
  }
